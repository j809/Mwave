...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_voiceDialog_t, stringdata) + ofs \
...
QT_MOC_LITERAL(2, 33, 0)
    ...
    "voiceDialog\0on_recbutton_clicked\0\0"
};
...
void voiceDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        voiceDialog *_t = static_cast<voiceDialog *>(_o);
        switch (_id) {
        case 0: _t->on_recbutton_clicked(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject voiceDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_voiceDialog.data,
      qt_meta_data_voiceDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_voiceDialog.stringdata))
        return static_cast<void*>(const_cast< voiceDialog*>(this));
